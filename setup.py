...
tallynn_package_dirs = {'ontvc': 'ontvc'}
...
setup(
    ...
    name='ontvc',
    version=version,
    description='ontvc : long-read bulk variant calling methods',
    author='Adam Cribbs',
    author_email='adam.cribbs@ndorms.ox.ac.uk',
    license="MIT",
    platforms=["any"],
    keywords="computational genomics",
    long_description='''ontvc : long-read bulk variant calling methods''',
    ...
    entry_points={
        "console_scripts": ["ontvc = ontvc.entry:main"]
    },
    # other options
    zip_safe=False,
    test_suite="tests",
